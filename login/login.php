...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="/ecommerce/login/validate_user.php" method="POST">
      <div>
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Don't have account?
      <a href="/ecommerce/login/signup.php" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">SignUp Now</a>
    </p>
  </div>
</div>
</section>
