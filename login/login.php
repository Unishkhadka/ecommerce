                ...
                <div class="card" style="border-radius: 1rem;">
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-5 d-none d-md-block">
                            <img src="/ecommerce/static/shopping.jpg" alt="login form" class="img-fluid"
                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body px-4 pt-4 text-black">
                                ...
                                <p style="color: #393f81;">Don't have an account? <a href="/ecommerce/login/signup.php"
                                        style="color: #393f81;">Register here</a></p>
                                        OR
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Log in as <a href="/ecommerce/login/signup.php"
                                        style="color: #393f81;">Admin</a> <i class="fa-solid fa-user-tie"></i></p>
                                        </div>
                            </div>
                        </div>
                    </div>
